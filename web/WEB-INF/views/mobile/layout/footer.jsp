    ...
    --%>
        ...
        <li><a href="live-shopping.html" id="nav-home"><i class="home-ic">홈</i></a></li>
        ...
        <hr>
        <ul class="cateList">
        <li><a href="#" class="noDp red">최근 본 영상</a></li>
        <li><a href="#" class="noDp red">공유한 영상</a></li>
        <li><a href="#" class="noDp red">인기 영상</a></li>
        <li>
        <a href="#">뷰티</a>
